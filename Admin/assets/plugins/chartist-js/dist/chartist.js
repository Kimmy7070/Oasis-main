(function(root, factory) {
    ...
    (function(window, document, Chartist) {
        ...
        // See http://mozilla.6506.n7.nabble.com/Specyfing-paths-with-percentages-unit-td247474.php
    ...
    (function(window, document, Chartist) {
        ...
        function foreignObject(content, attributes, className, insertFirst) {
            ...
            // http://www.w3.org/TR/SVG/extend.php#ForeignObjectElement)
        ...
        /**
         * The animate function lets you animate the current element with SMIL animations. You can add animations for multiple attributes at the same time by using an animation definition object. This object should contain SMIL animation attributes. Please refer to http://www.w3.org/TR/SVG/animate.php for a detailed specification about the available animation attributes. Additionally an easing property can be passed in the animation definition object. This can be a string with a name of an easing function in `Chartist.Svg.Easing` or an array with four numbers specifying a cubic Bézier curve.
    ...
    (function(window, document, Chartist) {
        ...
        function createChart(options) {
            ...
            // See this proposal for more details: http://lists.w3.org/Archives/Public/www-svg/2003Oct/0000.php
