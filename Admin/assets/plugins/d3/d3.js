...
(function(global, factory) {
    ...
    var centroidStream$1 = {
        ...
        result: function() {
            var centroid = Z2$1 ? [X2$1 / Z2$1, Y2$1 / Z2$1] :
                ...
                Z0$1 ? [X0$1 / Z0$1, Y0$1 / Z0$1] : [NaN, NaN];
            X0$1 = Y0$1 = Z0$1 =
                X1$1 = Y1$1 = Z1$1 =
                X2$1 = Y2$1 = Z2$1 = 0;
            return centroid;
    ...
    // http://egsc.usgs.gov/isb/pubs/MapProjections/projections.php#albers
    ...
    function quantize$1() {
        ...
        scale.invertExtent = function(y) {
            ...
            return i < 0 ? [NaN, NaN] :
                i < 1 ? [x0, domain[0]] :
                i >= n ? [domain[n - 1], x1] : [domain[i - 1], domain[i]];
        };
    ...
    // http://mathworld.wolfram.com/Circle-LineIntersection.php
    ...
    function link$2(curve) {
        ...
        function link() {
            var buffer, argv = slice$5.call(arguments),
                s = source.apply(this, argv),
                t = target.apply(this, argv);
            if (!context) context = buffer = path();
