...
* [d3.php](https://github.com/d3/d3-request/blob/master/README.md#html) - get an HTML file.
...
* [*selection*.php](https://github.com/d3/d3-selection/blob/master/README.md#selection_html) - get or set the inner HTML.
